...
class CrearXat : JFrame() {
    ...
    init {
        ...
        val docRef = database.collection("Xats").document("Xat-Prova")
        ...
        database.collection("Xats").document("Xat-Prova").collection("missatges").addSnapshotListener { snapshots, e ->
            if (e != null) {
                System.err.println("Listen failed: " + e)
                return@addSnapshotListener
            }
    ...
    fun enviar() {
        ...
        database.collection("Xats").document("Xat-Prova").collection("missatges").add(dades2)
    }
